...
public class SelectHandler implements Handler {
    ...
    @Override
    public List<Map<String, Object>> handle(SubcommandsMaintainer maintainer) throws TooManySubcommandsForCommandException {
        ...
        return repository.select(comparableOperator);
    }

    @Override
    public String getCommand() {
        return CommandName.SELECT;
    }
}
